...
parser.add_argument('--flowSize', default=10E6, help='set the size of every flow generated by the script - default 10MB')
#load distribution from file:
def main(target_load,destination,duration,filename, average_flow_size):
...
if __name__ == "__main__":
    ...
    fs = int(args.flowSize)
    num_repeats = 1

    filename = args.gbps + "G_consist_to_" + str(destination) + ".config"
    main(target_load,destination,duration,filename, fs)
